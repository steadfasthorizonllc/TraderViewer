...
IMPLEMENT_DYNAMIC(CAddColumnDialog, CDialog)

CAddColumnDialog::CAddColumnDialog(const CString& filePath, const CString& section, CWnd* pParent /*=nullptr*/)
    : CDialog(IDD_ADD_COLUMN, pParent)
{
...
CAddColumnDialog::~CAddColumnDialog()
{
}

void CAddColumnDialog::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CAddColumnDialog, CDialog)
    ON_BN_CLICKED(IDOK, &CAddColumnDialog::OnBnClickedButtonSave)
    ON_BN_CLICKED(IDCANCEL, &CAddColumnDialog::OnBnClickedButtonCancel)
END_MESSAGE_MAP()

BOOL CAddColumnDialog::OnInitDialog()
{
...
void CAddColumnDialog::OnBnClickedButtonSave()
{
...
void CAddColumnDialog::OnBnClickedButtonCancel()
{
    EndDialog(IDCANCEL);
}

void CAddColumnDialog::LoadColumnsFromIniFile()
{
...
void CAddColumnDialog::SaveColumnsToIniFile()
{
