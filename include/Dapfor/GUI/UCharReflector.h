...
{
//////////////////////////////////////////////////////////////////////////
/// \brief Performs edit in place operations with unsigned char-type fields in CNumericEdit control.
///
/// \version <b>2.0.0</b> Initial version
///
/// \class  CUCharReflector UCharReflector.h Dapfor/GUI/UCharReflector.h
/// \file UCharReflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CUCharReflector : public IControlReflector
{
public:
    CUCharReflector();              //!< Default constructor
    virtual ~CUCharReflector();     //!< Virtual destructor
