...
//////////////////////////////////////////////////////////////////////////
/// \brief Performs edit in place operations with short-type fields in CNumericEdit control.
///
/// \version <b>2.0.0</b> Initial version
///
/// \class  CShortReflector ShortReflector.h Dapfor/GUI/ShortReflector.h
/// \file ShortReflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CShortReflector : public IControlReflector
{
public:
    CShortReflector();              //!< Constructor
    virtual ~CShortReflector();     //!< Virtual destructor
