...
///
/// \class  CLongMsecTimeReflector LongMsecTimeReflector.h Dapfor/GUI/LongMsecTimeReflector.h
/// \file LongMsecTimeReflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CLongMsecTimeReflector : public IControlReflector
{
public:
    CLongMsecTimeReflector();           //!< Constructor
    virtual ~CLongMsecTimeReflector();  //!< Virtual destructor
    ...
    /// The function always returns alse. 
