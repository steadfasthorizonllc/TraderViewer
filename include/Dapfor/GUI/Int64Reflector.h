...
//////////////////////////////////////////////////////////////////////////
/// \brief Performs edit in place operations on __int64-type fields in CNumericEdit control.
///
/// \version <b>2.0.0</b> Initial version
///
/// \class  CInt64Reflector Int64Reflector.h Dapfor/GUI/Int64Reflector.h
/// \file Int64Reflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CInt64Reflector : public IControlReflector
{
public:
    CInt64Reflector();              //!< Constructor
    virtual ~CInt64Reflector();     //!< Virtual destructor
