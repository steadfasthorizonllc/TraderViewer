...
//////////////////////////////////////////////////////////////////////////
/// \brief Performs edit in place operations with unsigned short-type fields in CNumericEdit control.
///
/// \version <b>2.0.0</b> Initial version
///
/// \class  CUShortReflector UShortReflector.h Dapfor/GUI/UShortReflector.h
/// \file UShortReflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CUShortReflector : public IControlReflector
{
public:
    CUShortReflector();             //!< Constructor
    virtual ~CUShortReflector();    //!< Virtual destructor
