...
//////////////////////////////////////////////////////////////////////////
/// \brief Performs edit in place operations with double-type fields in CNumericEdit control.
///
/// \version <b>2.0.0</b> Initial version
///
/// \class  CDoubleReflector DoubleReflector.h Dapfor/GUI/DoubleReflector.h
/// \file DoubleReflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CDoubleReflector : public IControlReflector
{
public:
    CDoubleReflector();             //!< Constructor
    virtual ~CDoubleReflector();    //!< Virtual destructor
