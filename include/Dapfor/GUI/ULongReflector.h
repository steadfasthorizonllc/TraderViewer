...
//////////////////////////////////////////////////////////////////////////
/// \brief Performs edit in place operations with unsigned long-type fields in CNumericEdit control.
///
/// \version <b>2.0.0</b> Initial version
///
/// \class  CULongReflector ULongReflector.h Dapfor/GUI/ULongReflector.h
/// \file ULongReflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CULongReflector : public IControlReflector
{
public:
    CULongReflector();              //!< Constructor
    virtual ~CULongReflector();     //!< Virtual destructor
