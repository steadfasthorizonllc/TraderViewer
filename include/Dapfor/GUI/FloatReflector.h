...
//////////////////////////////////////////////////////////////////////////
/// \brief Performs edit in place operations with float-type fields in CNumericEdit control.
///
/// \version <b>2.0.0</b> Initial version
///
/// \class  CFloatReflector FloatReflector.h Dapfor/GUI/FloatReflector.h
/// \file FloatReflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CFloatReflector : public IControlReflector
{
public:
    CFloatReflector();              //!< Constructor
    virtual ~CFloatReflector();     //!< Virtual destructor
