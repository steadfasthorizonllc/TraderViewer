...
//////////////////////////////////////////////////////////////////////////
/// \brief Performs edit in place operations with char-type fields in CNumericEdit control.
///
/// \version <b>2.0.0</b> Initial version
///
/// \class  CCharReflector CharReflector.h Dapfor/GUI/CharReflector.h
/// \file CharReflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CCharReflector : public IControlReflector
{
public:
    CCharReflector();           //!< Default constructor
    virtual ~CCharReflector();  //!< Virtual destructor
