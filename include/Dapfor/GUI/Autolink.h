...
#ifndef __DF_GUI_AUTOLINK_64__H
#define __DF_GUI_AUTOLINK_64__H

#if defined(_WIN64)

#include <Dapfor/GUI/Autolink_64.h>
...
//use the configuration of Dapfor.Grid where the library Dapfor.Common has been compiled without MFC support.
    ...
    //--------------------------------------------
        ...
        //--------------------------------------------
            ...
            #ifdef _DEBUG
                #ifdef _UNICODE
                    #pragma comment(lib,"Dapfor.GUI10uds.lib") 
                    #pragma message("Automatically linking with Dapfor.GUI10uds.lib (Dapfor unicode debug static library, MFC static libraries, Debug multithreaded runtime library (switch /MTd))") 
                #else
                    #pragma comment(lib,"Dapfor.GUI10ds.lib") 
                    #pragma message("Automatically linking with Dapfor.GUI10ds.lib (Dapfor debug static library, MFC static libraries, Debug multithreaded runtime library (switch /MTd))") 
                #endif
            #else   // Release
                #ifdef _UNICODE
                    #pragma comment(lib,"Dapfor.GUI10us.lib") 
                    #pragma message("Automatically linking with Dapfor.GUI10us.lib (Dapfor unicode release static library, MFC static libraries, Multithreaded runtime library (switch /MT))") 
                #else
                    #pragma comment(lib,"Dapfor.GUI10s.lib") 
                    #pragma message("Automatically linking with Dapfor.GUI10s.lib (Dapfor release static library, MFC static libraries, Multithreaded runtime library (switch /MT))") 
                #endif
            #endif//_DEBUG
        ...
        //--------------------------------------------
            ...
            #ifdef _DEBUG
                #ifdef _UNICODE
                    #pragma comment(lib,"Dapfor.GUI10udss.lib") 
                    #pragma message("Automatically linking with Dapfor.GUI10udss.lib (Dapfor unicode debug static library, MFC shared DLL, Debug Multithreaded Dll runtime library (switch /MDd))") 
                #else
                    #pragma comment(lib,"Dapfor.GUI10dss.lib") 
                    #pragma message("Automatically linking with Dapfor.GUI10dss.lib (Dapfor debug static library, MFC shared DLL, Debug Multithreaded Dll runtime library (switch /MDd))") 
                #endif
            #else   // Release
                #ifdef _UNICODE
                    #pragma comment(lib,"Dapfor.GUI10uss.lib") 
                    #pragma message("Automatically linking with Dapfor.GUI10uss.lib (Dapfor unicode release static library, MFC shared DLL, Multithreaded Dll runtime library (switch /MD))") 
                #else
                    #pragma comment(lib,"Dapfor.GUI10ss.lib") 
                    #pragma message("Automatically linking with Dapfor.GUI10ss.lib (Dapfor release static library, MFC shared DLL, Multithreaded Dll runtime library (switch /MD))") 
                #endif
            #endif//_DEBUG
        #endif
