...
//////////////////////////////////////////////////////////////////////////
/// \brief Performs edit in place operations with any field type in CEdit control.
///
/// \version <b>2.0.0</b> Initial version
///
/// \class  CDefaultReflector DefaultReflector.h Dapfor/GUI/DefaultReflector.h
/// \file DefaultReflector.h
//////////////////////////////////////////////////////////////////////////
class DF_GUI_API CDefaultReflector : public IControlReflector
{
public:
    CDefaultReflector();            //!< Constructor
    virtual ~CDefaultReflector();   //!< Virtual destructor
...
public:
    ...
    // Applies the new value set by the user in MFC control for specified field in the data object.
    ...
    /// Indicates that MFC control can be activated if the user clicks on the cell.
